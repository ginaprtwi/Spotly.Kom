	...
	<div class="detail-tempat">
		<div class="detail-tempat-navbar">
			...
			<div class="detail-tempat-nav">
				<p class="detail-tempat-text-btn1">Beranda</p>
				<p class="detail-tempat-text-btn2">Pengelolaan Tempat</p>
